...
function App() {
  ...
  function handleLoginClick() {
    ...
    !isLoggedIn ? history.push("/Artworks") : history.push("/");
  }
  ...
  function handleChangeBuyers(e) {
    ...
    currentBuyer = allBuyers.find(
      (buyer) => buyer.first_name === e.target.value
    );
  ...
  return (
    <div>
      <NavBar isLoggedIn={isLoggedIn} currentBuyer={currentBuyer} />
      <Switch>
        <Route exact path="/">
          <HomePage
        ...
        <Route exact path="/Artworks">
          <Artworks allArtwork={allArtwork} currentBuyer={currentBuyer} />
        </Route>
        ...
        <Route path="/artworks/:id">
          <ArtworkDetails currentBuyer={currentBuyer} />
        </Route>
      </Switch>
    </div>
  );
